...
class TestConnectionOperationalAPI(unittest.TestCase):
    ...
    def create_spec(self):
        ...
        spec = ResourceSpecification({'type_name': 'Switch', 'description': 'default spec for Switch'},
                                     params_spec=[param_1, param_2])

        return spec

    def create_conn(self):
        update_conn1 = {"_id": objectid.ObjectId("5010319237adc71128000000"), "specification_name": "L3",
                        "connecting_resource": "5010319237adc71128000001",
                        "connected_resource": "5010319237adc71128000003",
                        "additional_parameters": {"Port_one" : 10, "Port_two": 30}}
        update_conn2 = {"_id": objectid.ObjectId("5010319237adc71128000000"), "specification_name": "L3",
                        "connecting_resource": "5010319237adc71128000001",
                        "connected_resource": "5010319237adc71128000003",
                        "additional_parameters": {"Port_one": 24, "Port_two" : 30, 'new_name': 'new_value'}}
